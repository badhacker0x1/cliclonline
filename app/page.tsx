    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-cyan-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">Internet Service Provider</p>
              </div>
            </div>
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Link href="#why-choose" className="text-gray-700 hover:text-cyan-600 transition-colors">
                Why Choose Us?
              </Link>
              <Link href="#packages" className="text-gray-700 hover:text-cyan-600 transition-colors">
                Packages
              </Link>
              <Link href="#coverage" className="text-gray-700 hover:text-cyan-600 transition-colors">
                Coverage
              </Link>
            ...
            <div className="flex items-center space-x-4">
              ...
              <span className="text-sm font-medium">+880 1716 222 979</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <section className="relative overflow-hidden py-20 lg:py-32 min-h-screen flex items-center">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-tr from-blue-600/10 via-transparent to-orange-500/10"></div>
          ...
          <div className="absolute top-40 right-20 w-24 h-24 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full opacity-30 animate-float animation-delay-500"></div>
          ...
          <div className="absolute bottom-20 right-1/3 w-28 h-28 bg-gradient-to-r from-green-400 to-cyan-500 rounded-full opacity-20 animate-float animation-delay-300"></div>
          ...
          <div className="absolute top-0 left-0 w-full h-full">
            ...
            <div className="absolute top-1/2 left-0 w-full h-px bg-gradient-to-r from-transparent via-purple-500/30 to-transparent animate-pulse animation-delay-400"></div>
            <div className="absolute top-3/4 left-0 w-full h-px bg-gradient-to-r from-transparent via-pink-500/30 to-transparent animate-pulse animation-delay-800"></div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="animate-fade-in-up">
                <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 backdrop-blur-sm border border-cyan-500/20 rounded-full px-6 py-3 animate-bounce-slow">
                  <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                  <span className="text-sm font-medium bg-gradient-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent">
              ...
              <div className="space-y-4 animate-fade-in-up animation-delay-200">
                <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
                  <span className="block overflow-hidden">
                    <span className="inline-block bg-gradient-to-r from-gray-900 via-cyan-600 to-purple-600 bg-clip-text text-transparent animate-slide-in-bottom">
                      Fastest
                    </span>
                  </span>
                  <span className="block overflow-hidden">
                    <span className="inline-block bg-gradient-to-r from-cyan-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-slide-in-bottom animation-delay-300">
                      Speed
                    </span>
                  </span>
                  <span className="block overflow-hidden">
                    <span className="inline-block text-gray-900 animate-slide-in-bottom animation-delay-600">
              ...
              <div className="flex flex-col sm:flex-row gap-6 animate-fade-in-up animation-delay-900">
                <Button
                  size="lg"
                  className="group relative overflow-hidden bg-gradient-to-r from-cyan-500 to-purple-500 text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl"
                  asChild
                >
                  <Link href="#packages">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="group relative overflow-hidden border-2 border-cyan-500 text-cyan-600 px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 hover:scale-105 hover:bg-cyan-50 bg-transparent"
                  asChild
                >
              ...
              <div className="grid grid-cols-3 gap-8 pt-12 animate-fade-in-up animation-delay-1000">
                <div className="text-center group">
                  <div className="relative">
                    <div className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">
                      99.9
                    </div>
                ...
                <div className="text-center group">
                  <div className="relative">
                    <div className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">
                      24/7
                    </div>
                    <div className="absolute -top-2 -right-2 w-3 h-3 bg-purple-500 rounded-full animate-ping animation-delay-300"></div>
                  </div>
                  <div className="text-sm text-gray-600 mt-2">Support</div>
                </div>
                <div className="text-center group">
                  <div className="relative">
                    <div className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-pink-600 to-orange-600 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">
                      3X
                    </div>
                    <div className="absolute -top-2 -right-2 w-3 h-3 bg-pink-500 rounded-full animate-ping animation-delay-600"></div>
                  </div>
                  <div className="text-sm text-gray-600 mt-2">Faster Speed</div>
                </div>
              </div>
            </div>
            ...
            <div className="relative animate-fade-in-left animation-delay-400 flex items-center justify-center h-[600px] lg:h-[700px]">
              {/* Central Glowing Orb */}
              <div className="absolute w-64 h-64 bg-gradient-to-br from-cyan-500/30 via-purple-500/30 to-pink-500/30 rounded-full flex items-center justify-center animate-glow">
                <Wifi className="w-24 h-24 text-white opacity-80 animate-pulse" />
              </div>

              {/* Floating Elements Around Central Orb */}
              <div className="absolute -top-8 -left-8 w-16 h-16 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-2xl flex items-center justify-center animate-float shadow-lg">
                <Globe className="w-8 h-8 text-white" />
              </div>
              <div className="absolute -top-4 -right-12 w-20 h-20 bg-gradient-to-r from-purple-400 to-pink-500 rounded-2xl flex items-center justify-center animate-float animation-delay-300 shadow-lg">
              ...
              <div className="absolute -bottom-4 -right-8 w-16 h-16 bg-gradient-to-r from-green-400 to-cyan-500 rounded-2xl flex items-center justify-center animate-float animation-delay-900 shadow-lg">
              ...
              <div className="absolute inset-0 pointer-events-none">
                ...
                ></div>
                <div
                  className="absolute top-1/2 right-1/3 w-2 h-2 bg-purple-400 rounded-full animate-float"
                  style={{ animationDelay: "1200ms", animationDuration: "5s" }}
                ></div>
                <div
                  className="absolute bottom-1/4 left-1/2 w-2 h-2 bg-pink-400 rounded-full animate-float"
      ...
      <section id="services" className="py-20 bg-gradient-to-br from-gray-50 to-cyan-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">Comprehensive Internet Solutions</h2>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            <Card
              className="group hover:shadow-xl transition-all duration-300 border-0 bg-white/80 backdrop-blur-sm hover:-translate-y-2 animate-fade-in-up"
              style={{ animationDelay: `0ms` }}
            >
              <CardHeader className="text-center pb-4">
                <div className="w-16 h-16 mx-auto bg-gradient-to-br from-cyan-500 to-blue-500 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                  <Wifi className="w-8 h-8 text-white" />
                </div>
                <CardTitle className="text-xl">Home Internet</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            >
              <CardHeader className="text-center pb-4">
                <div className="w-16 h-16 mx-auto bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                  <Building2 className="w-8 h-8 text-white" />
                </div>
                <CardTitle className="text-xl">Corporate Internet</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-center text-gray-600">
            ...
            >
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl">Network Solution</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-center text-gray-600">
      ...
      <section id="why-choose" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">What Makes Us Different</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group animate-fade-in-up" style={{ animationDelay: `0ms` }}>
              ...
              <h3 className="text-xl font-semibold mb-4">Uptime & Reliability</h3>
            ...
            <div className="text-center group animate-fade-in-up" style={{ animationDelay: `150ms` }}>
              <div className="w-20 h-20 mx-auto bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
                <Globe className="w-10 h-10 text-white" />
              </div>
              <h3 className="text-xl font-semibold mb-4">Multiple Upstream</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center group animate-fade-in-up" style={{ animationDelay: `300ms` }}>
              <div className="w-20 h-20 mx-auto bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
      ...
      {/* Packages Section */}
      <section id="packages" className="py-20 bg-gradient-to-br from-gray-50 to-purple-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-4">Our Packages</Badge>
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">Choose Your Perfect Plan</h2>
          </div>

          {/* BTRC Packages */}
          <div className="mb-16">
            <h3 className="text-2xl font-bold text-center mb-8 text-gray-800">BTRC Packages</h3>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <Card
                  key={index}
                  className="relative overflow-hidden border-0 bg-white shadow-lg hover:shadow-xl transition-all duration-300 scroll-animate"
                >
                  ...
                  <CardContent className="space-y-4">
                    <div className="text-center">
                      <div className="text-xl font-semibold text-gray-900">{pkg.speed}</div>
                      <div className="text-sm text-gray-600">Shared Ratio {pkg.ratio}</div>
                      <div className="text-sm text-gray-600">Min: {pkg.min}</div>
                    </div>
          ...
          <div>
            <h3 className="text-2xl font-bold text-center mb-8 text-gray-800">Special Home Packages</h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <Card
                  key={index}
                  className={`relative overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 scroll-animate hover-lift ${pkg.featured ? "bg-gradient-to-br from-cyan-50 to-purple-50 ring-2 ring-cyan-500" : "bg-white"}`}
                >
                  {pkg.featured && (
                    <div className="absolute top-4 right-4">
                      <Badge className="bg-gradient-to-r from-cyan-500 to-purple-500 text-white">Popular</Badge>
                    </div>
                  )}
                  <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-cyan-500 to-purple-500"></div>
                  <CardHeader className="text-center pb-4">
                    <div className="text-2xl font-bold text-cyan-600">{pkg.speed} Mbps</div>
                    ...
                    <div className="space-y-2">
                      ...
                      {pkg.speed === "80" && (
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm font-medium">Public IP Free</span>
                        </div>
                      )}
                    </div>
                    <Button
                      className={`w-full ${pkg.featured ? "bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 text-white" : "bg-gray-900 hover:bg-gray-800 text-white"} border-0`}
                    >
                      Call for Get
                    </Button>
                  </CardContent>
      ...
      <section id="coverage" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">Areas We Serve</h2>
          </div>
            ...
            {["Hatirjheel", "Ramna", "Khilgaon"].map((area, index) => (
              ...
              >
                <CardContent className="p-8 text-center">
                  <div className="w-16 h-16 mx-auto bg-gradient-to-br from-cyan-500 to-purple-500 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
      ...
      <section className="py-20 bg-gradient-to-br from-purple-50 to-pink-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-4">Entertainment Zone</Badge>
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">Premium Entertainment Services</h2>
          </div>
            ...
            {[
              ...
              >
                <CardContent className="p-6 text-center">
                  <div className="w-12 h-12 mx-auto bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <Play className="w-6 h-6 text-white" />
                  </div>
                  <h3 className="font-semibold text-gray-900 mb-3">{service.name}</h3>
                  <Button
                    size="sm"
                    className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white border-0 text-xs"
                    asChild
                  >
      ...
      <section id="contact" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">Need Support or Have Any Query?</h2>
            <p className="text-xl text-gray-600">Feel free to call us!</p>
          </div>

          <div className="grid lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-semibold mb-6">Address & Contact</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <MapPin className="w-5 h-5 text-cyan-600 mt-1" />
                    <div>
                      <div className="font-medium">Click Online - (ISP)</div>
                      <div className="text-gray-600">557, Noyatola Road, Maghbazar</div>
                      <div className="text-gray-600">Dhaka-1217, Bangladesh</div>
                    </div>
                  </div>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-6">Send a Mail</h3>
